...
const ProfessionalTanglishCompiler = () => {
...
} illai endraal score >= 70 {
    grade = "B"
    kaattu "Good! Grade: " + grade
} illai {
...
// For loop simulation
vaippu j = 0
kaattu "Counting with for simulation:"
thirumba j < 3 {
    kaattu "Iteration: " + j
    j = j + 1
}`
    },
    {
      ...
      category: 'Advanced',
      code: `karuthu "String Manipulation"

vaippu first_name = "Tamil"
vaippu last_name = "Programming"
vaippu full_name = first_name + " " + last_name
vaippu language = "Tanglish"

kaattu "Full Name: " + full_name
kaattu "Language: " + language
kaattu "Length: " + 20  // Simulated string length`
    },
    {
      name: '🧮 Boolean Logic',
      category: 'Logic',
      code: `karuthu "Boolean Operations"

vaippu is_student = unmai
vaippu is_working = poi
vaippu age = 22

// Complex conditions
endraal is_student == unmai && age >= 18 {
    kaattu "Adult student"
} illai endraal is_working == unmai {
    kaattu "Working professional"
} illai {
    kaattu "Other category"
}

// Boolean operations
vaippu result = is_student && is_working
kaattu "Student and Working: " + result`
    }
  ];
...
`);
  ...
  const handleEditorDidMount = (editor, monaco) => {
    ...
    // Enhanced Tanglish language tokens
        ...
        <div className="absolute right-4 top-20 bg-slate-800/95 backdrop-blur-lg rounded-xl shadow-2xl border border-purple-500/20 z-10 w-80">
          <div className="p-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-sm text-gray-300 block mb-1">Word Wrap</label>
                <select
                  value={wordWrap}
...
export default ProfessionalTanglishCompiler;
